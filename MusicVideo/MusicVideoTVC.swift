...
class MusicVideoTVC: UITableViewController {
    ...
    func reachabilityStatusChanged() {
        ...
        case NOACCESS :
            ...
            dispatch_async(dispatch_get_main_queue()){
                ...
                let okAction = UIAlertAction(title: "ok", style: .Default) { action -> Void in print("Ok")}
    ...
    func runAPI() {
        //Call API
        let api = APIManager()
        api.loadData("https://itunes.apple.com/us/rss/topmusicvideos/limit=70/json", completion: didLoadData)
    }
